class AppUrl {
  // Base URLs
  static const String baseUrl = 'https://kena.mlbdev.com/api';
  ...
  static const String getUserReviews = '$baseUrl/auth/user/ratings';
  ...
  static const String decrementRequests =
      '$baseUrl/auth/user/requests/decrement';
