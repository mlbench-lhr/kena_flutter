...
// import 'package:kena/model/user/user_reviews_model.dart';
...
//   Future<UserReviewsResponse?> getUserReviews(BuildContext context) async {
//     try {
//       final user = SessionController().user;
//       if (user == null || user.id == null) {
//         throw Exception("User session not found or user ID is missing");
//       }

//       final response = await _userHomeRepo.getUserReviews();
...
//   ///
//   /// Decrement user's meetup requests (calls backend API)
//   ///
//   Future<bool> decrementMeetupRequests(BuildContext context) async {
//     try {
//       await _userHomeRepo.decrementRequests();
//       debugPrint('✅ Meetup requests decremented successfully!');

//       // Refresh user profile to get updated requestsRemaining count
//       if (context.mounted) {
//         await AuthService().fetchProfile(context);
//       }
