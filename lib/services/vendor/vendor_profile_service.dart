...
//     debugPrint(
//       '🍔 [VendorProfileService] ${isEdit ? "Editing" : "Adding"} product:',
//     );
//     debugPrint('   - Name: $productName');
//     debugPrint('   - Category: $category');
//     debugPrint('   - Image: ${imageUrl != null ? "Present" : "Missing"}');
...
//     VoidCallback? onSuccess,
//   }) async {
//     debugPrint('🗑️ [VendorProfileService] Deleting product: $productId');
//     try {
